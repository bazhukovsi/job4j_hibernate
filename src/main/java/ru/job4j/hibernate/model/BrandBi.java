...
public class BrandBi {
    ...
    public static BrandBi of(String name) {
        BrandBi brand = new BrandBi();
        brand.name = name;
        return brand;
    }
    ...
    public boolean equals(Object o) {
        ...
        return id == brandBi.id && Objects.equals(name, brandBi.name) && Objects.equals(models, brandBi.models);
    }
